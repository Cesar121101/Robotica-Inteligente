...
if __name__=="__main__":
    ...
    cmd_wr_pub = rospy.Publisher("/cmd_wR", Float32 , queue_size=10)
    cmd_wl_pub = rospy.Publisher("/cmd_wL", Float32 , queue_size=10)
    ...
    try:
        while not rospy.is_shutdown():
            ...
            wr_pub.publish(wr)
            wl_pub.publish(wl)
            cmd_wr_pub.publish(wr)
            cmd_wl_pub.publish(wl)
