...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if current_state == 0:
            ...
            if check_dir(lsr_dists, 0.3, 160, 201):
                current_state = 7
            else:
            ...
            if angle_dir == 360:
                angle_dir = 0
            #print("Indp:",angle_indp_bug)
            #print("N:",lsr_dists[180])
            #print("I:",lsr_dists[270],"D:", lsr_dists[90])
            #print("S:",lsr_dists[0])
            print("Angle:",angle_dir)
            print("Mes:",lsr_dists[angle_dir])
            

            if lsr_dists[angle_dir] > 5.0 or check_around(lsr_dists):
